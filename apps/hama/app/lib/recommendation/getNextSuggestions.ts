...
export function getNextSuggestions(
  ...
  if (options?.courseFallback) {
    return [
      { id: "cf1", label: "카페 가기", icon: "☕", query: "카페 추천" },
      { id: "cf2", label: "점심 정하기", icon: "🍚", query: "점심 뭐 먹지" },
  ...
  if (it === "search_strict") {
    if (cat === "FOOD") {
      return [
        { id: "n1", label: "카페 가기", icon: "☕", query: "카페 가기 좋은 데 추천" },
    ...
    if (cat === "CAFE") {
      return [
        ...
        { id: "n2", label: "식사 이어가기", icon: "🍚", query: "점심 뭐 먹지" },
        { id: "n3", label: "놀거리", icon: "🎯", query: "놀거리 추천" },
      ];
    }
    if (cat === "BEAUTY") {
      return [
        { id: "n1", label: "카페에서 쉬기", icon: "☕", query: "카페 가기 좋은 데 추천" },
    ...
    if (cat === "ACTIVITY") {
      return [
        { id: "n1", label: "카페", icon: "☕", query: "카페 추천" },
  ...
  return [
    { id: "n1", label: "점심 정하기", icon: "🍚", query: "점심 뭐 먹지" },
    { id: "n2", label: "카페 가기", icon: "☕", query: "카페 추천" },
    { id: "n3", label: "데이트 코스", icon: "💕", query: "데이트 코스 짜줘" },
  ];
}
