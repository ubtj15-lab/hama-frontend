...
export const HamaEvents = {
  ...
  hama_pay_available_viewed: "hama_pay_available_viewed",
  hama_pay_mock_completed: "hama_pay_mock_completed",
  visit_feedback_submitted: "visit_feedback_submitted",
  decision_confirmed: "decision_confirmed",
  receipt_verification_started: "receipt_verification_started",
  receipt_verification_submitted: "receipt_verification_submitted",
  receipt_verification_approved: "receipt_verification_approved",
  receipt_verification_rejected: "receipt_verification_rejected",
  admin_receipt_approved: "admin_receipt_approved",
  admin_receipt_rejected: "admin_receipt_rejected",
  beta_reward_completed: "beta_reward_completed",
