-- Recovery only: Phase A/B analytics tables that were never created on this project.
-- Extracted from 20260426143000_recommendations_v2_and_places_category_expand.sql
-- Excludes that file's ALTER TABLE places (incompatible: this project has no places.category).
-- Do not run 20260426143000 as a whole.
